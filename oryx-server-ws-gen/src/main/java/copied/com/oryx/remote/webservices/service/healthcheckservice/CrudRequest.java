 ...
 *         &lt;element name="Object" type="{http://health.bu.model.element.webservice.remote.oryx.com}XmlHealthCheck" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlHealthCheck> object;
     ...
     * {@link XmlHealthCheck }
     */
    public List<XmlHealthCheck> getObject() {
        if (object == null) {
            object = new ArrayList<XmlHealthCheck>();
        }
        return this.object;
    }
