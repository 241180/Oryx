 ...
 *         &lt;element name="Object" type="{http://health.bu.model.element.webservice.remote.oryx.com}XmlPatient" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlPatient> object;
     ...
     * {@link XmlPatient }
     */
    public List<XmlPatient> getObject() {
        if (object == null) {
            object = new ArrayList<XmlPatient>();
        }
        return this.object;
    }
