package com.oryx.remote.webservices.service.fieldprocessparamservice;
 ...
 *         &lt;element name="Object" type="{http://ose.system.model.element.webservice.remote.oryx.com}XmlFieldProcessParam" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudResponse {
    ...
    protected List<XmlFieldProcessParam> object;
     ...
     * {@link XmlFieldProcessParam }
     */
    public List<XmlFieldProcessParam> getObject() {
        if (object == null) {
            object = new ArrayList<XmlFieldProcessParam>();
        }
        return this.object;
    }
