 ...
 */
@WebService(name = "ProductCategoryService", targetNamespace = "http://enum.element.webservice.remote.oryx.com")
...
@XmlSeeAlso({
        ...
        com.oryx.remote.webservices.service.productcategoryservice.ObjectFactory.class,
...
public interface ProductCategoryService {
    ...
    /**
     * @param crudRequest
     * @return returns com.oryx.remote.webservices.service.productcategoryservice.CrudResponse
     */
    @WebMethod
    @WebResult(name = "crudResponse", targetNamespace = "http://com/oryx/remote/webservices/service/productcategoryservice", partName = "crudResponse")
    public CrudResponse crud(
            @WebParam(name = "crudRequest", targetNamespace = "http://com/oryx/remote/webservices/service/productcategoryservice", partName = "crudRequest")
