 ...
 */
@WebService(name = "UserService", targetNamespace = "http://enum.element.webservice.remote.oryx.com")
...
@XmlSeeAlso({
        ...
        com.oryx.remote.webservices.service.userservice.ObjectFactory.class,
...
public interface UserService {
    ...
    /**
     * @param crudRequest
     * @return returns com.oryx.remote.webservices.service.userservice.CrudResponse
     */
    @WebMethod
    @WebResult(name = "crudResponse", targetNamespace = "http://com/oryx/remote/webservices/service/userservice", partName = "crudResponse")
    public CrudResponse crud(
            @WebParam(name = "crudRequest", targetNamespace = "http://com/oryx/remote/webservices/service/userservice", partName = "crudRequest")
