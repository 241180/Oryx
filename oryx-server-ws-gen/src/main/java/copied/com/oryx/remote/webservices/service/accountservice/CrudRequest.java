 ...
 *         &lt;element name="Object" type="{http://billing.bu.model.element.webservice.remote.oryx.com}XmlAccount" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlAccount> object;
     ...
     * {@link XmlAccount }
     */
    public List<XmlAccount> getObject() {
        if (object == null) {
            object = new ArrayList<XmlAccount>();
        }
        return this.object;
    }
