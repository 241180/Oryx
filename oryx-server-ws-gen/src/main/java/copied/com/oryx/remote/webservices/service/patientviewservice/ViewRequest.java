package com.oryx.remote.webservices.service.patientviewservice;
 ...
 *         &lt;element name="Object" type="{http://health.bu.view.element.webservice.remote.oryx.com}XmlPatientView" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "viewRequest")
public class ViewRequest {
    ...
    protected List<XmlPatientView> object;
     ...
     * {@link XmlPatientView }
     */
    public List<XmlPatientView> getObject() {
        if (object == null) {
            object = new ArrayList<XmlPatientView>();
        }
        return this.object;
    }
