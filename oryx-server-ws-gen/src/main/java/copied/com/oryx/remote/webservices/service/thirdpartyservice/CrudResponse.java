 ...
 *         &lt;element name="Object" type="{http://ref.system.model.element.webservice.remote.oryx.com}XmlThirdParty" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudResponse {
    ...
    protected List<XmlThirdParty> object;
     ...
     * {@link XmlThirdParty }
     */
    public List<XmlThirdParty> getObject() {
        if (object == null) {
            object = new ArrayList<XmlThirdParty>();
        }
        return this.object;
    }
