 ...
 *         &lt;element name="Object" type="{http://stock.bu.model.element.webservice.remote.oryx.com}XmlProductLot" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlProductLot> object;
     ...
     * {@link XmlProductLot }
     */
    public List<XmlProductLot> getObject() {
        if (object == null) {
            object = new ArrayList<XmlProductLot>();
        }
        return this.object;
    }
