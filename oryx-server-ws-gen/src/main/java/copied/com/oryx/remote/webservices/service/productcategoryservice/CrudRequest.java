package com.oryx.remote.webservices.service.productcategoryservice;
 ...
 *         &lt;element name="Object" type="{http://sale.bu.model.element.webservice.remote.oryx.com}XmlProductCategory" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlProductCategory> object;
     ...
     */
    public List<XmlProductCategory> getObject() {
        if (object == null) {
            object = new ArrayList<XmlProductCategory>();
        }
        return this.object;
    }
