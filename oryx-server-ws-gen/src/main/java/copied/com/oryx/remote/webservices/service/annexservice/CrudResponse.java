 ...
 *         &lt;element name="Object" type="{http://ose.system.model.element.webservice.remote.oryx.com}XmlAnnex" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudResponse {
    ...
    protected List<XmlAnnex> object;
     ...
     * {@link XmlAnnex }
     */
    public List<XmlAnnex> getObject() {
        if (object == null) {
            object = new ArrayList<XmlAnnex>();
        }
        return this.object;
    }
