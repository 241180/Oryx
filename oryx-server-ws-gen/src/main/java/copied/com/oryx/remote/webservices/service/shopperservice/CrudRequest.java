 ...
 *         &lt;element name="Object" type="{http://sale.bu.model.element.webservice.remote.oryx.com}XmlShopper" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlShopper> object;
     ...
     * {@link XmlShopper }
     */
    public List<XmlShopper> getObject() {
        if (object == null) {
            object = new ArrayList<XmlShopper>();
        }
        return this.object;
    }
