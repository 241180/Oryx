 ...
 *         &lt;element name="Object" type="{http://ref.system.model.element.webservice.remote.oryx.com}XmlState" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlState> object;
     ...
     * {@link XmlState }
     */
    public List<XmlState> getObject() {
        if (object == null) {
            object = new ArrayList<XmlState>();
        }
        return this.object;
    }
