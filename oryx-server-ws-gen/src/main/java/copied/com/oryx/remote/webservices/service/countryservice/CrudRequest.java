 ...
 *         &lt;element name="Object" type="{http://ref.system.model.element.webservice.remote.oryx.com}XmlCountry" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlCountry> object;
     ...
     * {@link XmlCountry }
     */
    public List<XmlCountry> getObject() {
        if (object == null) {
            object = new ArrayList<XmlCountry>();
        }
        return this.object;
    }
