 ...
 *         &lt;element name="Object" type="{http://ose.system.model.element.webservice.remote.oryx.com}XmlUpgrades" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlUpgrades> object;
     ...
     * {@link XmlUpgrades }
     */
    public List<XmlUpgrades> getObject() {
        if (object == null) {
            object = new ArrayList<XmlUpgrades>();
        }
        return this.object;
    }
