...
import com.oryx.core.annotation.processor.builder.BuilderStyle;
 ...
 * <p>
 * When the @Builder annotation is present on an element, the Oryx annotation processor
 ...
 * of the annotated class (you can use the {@link Ignore} annotation to
 ...
 *          </code></pre>
 * <p>
 * ...Oryx will generate the following Builder class:
 * <p>
 * <pre><code>
