...
@XmlType(name = "XmlCancelableAndTracable", namespace = "http://model.element.webservice.remote.oryx.com")
@MappedSuperclass
public abstract class CancelableAndTracable extends Tracable {
