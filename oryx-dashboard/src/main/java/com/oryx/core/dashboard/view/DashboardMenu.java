...
import com.oryx.core.dashboard.component.ProfilePreferencesWindow;
import com.oryx.core.dashboard.domain.Transaction;
import com.oryx.core.dashboard.domain.User;
import com.oryx.core.dashboard.event.DashboardEvent.*;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("Oryx <strong>Dashboard</strong>",
                ContentMode.HTML);
