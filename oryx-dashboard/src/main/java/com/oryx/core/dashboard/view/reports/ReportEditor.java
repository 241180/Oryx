...
import com.oryx.core.dashboard.component.InlineTextEditor;
import com.oryx.core.dashboard.component.TopTenMoviesTable;
import com.oryx.core.dashboard.component.TransactionsListing;
import com.oryx.core.dashboard.domain.Transaction;
            ...
            public void drop(final DragAndDropEvent dropEvent) {
                ...
                if (sourceComponent instanceof WrappedComponent) {
                    ...
                    if (next == null || next != target) {
                        // component not found - if dragging from another ui
                        return;
                    }
