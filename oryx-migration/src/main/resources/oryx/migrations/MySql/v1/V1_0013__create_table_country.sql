...
CREATE TABLE `t_country` (
  ...
  `ECO_CAPITAL_ID` binary(16) DEFAULT NULL,
  `POL_CAPITAL_ID` binary(16) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UC_NAME` (`NAME`),
  KEY `FK_COUNTRY_REF_ECO_CAPITAL` (`ECO_CAPITAL_ID`),
  KEY `FK_COUNTRY_REF_POL_CAPITAL` (`POL_CAPITAL_ID`),
  CONSTRAINT `FK_COUNTRY_REF_ECO_CAPITAL` FOREIGN KEY (`ECO_CAPITAL_ID`) REFERENCES `t_state` (`ID`),
  CONSTRAINT `FK_COUNTRY_REF_POL_CAPITAL` FOREIGN KEY (`POL_CAPITAL_ID`) REFERENCES `t_state` (`ID`)
