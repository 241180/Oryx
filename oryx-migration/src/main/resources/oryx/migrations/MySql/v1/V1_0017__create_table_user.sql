...
CREATE TABLE `t_user` (
  ...
  UNIQUE KEY `UC_USER_PERSON_ID` (`PERSON_ID`),
  UNIQUE KEY `UC_USER_LOGIN` (`LOGIN`),
  KEY `FK_USER_REF_PERSON` (`PERSON_ID`),
  CONSTRAINT `FK_USER_REF_PERSON` FOREIGN KEY (`PERSON_ID`) REFERENCES `t_person` (`ID`)
