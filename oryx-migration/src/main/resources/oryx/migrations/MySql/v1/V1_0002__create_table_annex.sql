...
--
-- Table structure for table `t_annex`
--
...
CREATE TABLE `t_annex` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UC_ANNEX_CODE_LANG_VALUE` (`CODE`,`LANGUAGE_CODE`,`VALUE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `t_annex`
--
-- ORDER BY:  `ID`

LOCK TABLES `t_annex` WRITE;
/*!40000 ALTER TABLE `t_annex` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_annex` ENABLE KEYS */;
UNLOCK TABLES;
