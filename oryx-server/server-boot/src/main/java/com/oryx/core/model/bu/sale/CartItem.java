...
@XmlType(name = "XmlCartItem", namespace = "http://sale.bu.model.element.webservice.remote.oryx.com")
@GenServiceDelegate
...
@Entity
@Table(
        name = SchemaConstantName.T_CART_ITEM
        /*, uniqueConstraints = {
...
public class CartItem extends CancelableAndTracable {
