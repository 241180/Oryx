...
@XmlType(name = "XmlProductCategory", namespace = "http://sale.bu.model.element.webservice.remote.oryx.com")
@GenServiceDelegate
...
@Entity
@Table(
        name = SchemaConstantName.T_PRODUCT_CATEGORY
        /*, uniqueConstraints = {
...
public class ProductCategory extends CancelableAndTracable {
