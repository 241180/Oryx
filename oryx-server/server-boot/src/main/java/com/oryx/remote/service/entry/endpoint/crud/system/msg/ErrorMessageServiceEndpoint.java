...
import com.oryx.core.model.provider.system.msg.ErrorMessageTypeByTokenProvider;
import com.oryx.remote.service.entry.endpoint.crud.namespace.TargetNameSpace;
import com.oryx.remote.service.entry.factory.exchangeObject.crud.system.msg.ErrorMessageExchangeObjFactory;
...
public class ErrorMessageServiceEndpoint extends ServiceEndpoint<XmlErrorMessage, CrudRequest, CrudResponse, XmlOperationDescIn, XmlOperationDescOut> {

    final static Logger logger = Logger.getLogger(ErrorMessageServiceEndpoint.class);

    @PayloadRoot(localPart = TargetNameSpace.CRUD_REQUEST_LOCAL_PORT, namespace = TargetNameSpace.TARGET_NAMESPACE_ERROR_MESSAGE)
    public
    @ResponsePayload
