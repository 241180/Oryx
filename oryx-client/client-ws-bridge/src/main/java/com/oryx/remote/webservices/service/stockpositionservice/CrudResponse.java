package com.oryx.remote.webservices.service.stockpositionservice;
 ...
 *         &lt;element name="Object" type="{http://stock.bu.model.element.webservice.remote.oryx.com}XmlStockPosition" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudResponse {
    ...
    protected List<XmlStockPosition> object;
     ...
     * {@link XmlStockPosition }
     */
    public List<XmlStockPosition> getObject() {
        if (object == null) {
            object = new ArrayList<XmlStockPosition>();
        }
        return this.object;
    }
