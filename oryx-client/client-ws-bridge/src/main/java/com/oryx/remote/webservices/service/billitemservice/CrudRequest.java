 ...
 *         &lt;element name="Object" type="{http://billing.bu.model.element.webservice.remote.oryx.com}XmlBillItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlBillItem> object;
     ...
     * {@link XmlBillItem }
     */
    public List<XmlBillItem> getObject() {
        if (object == null) {
            object = new ArrayList<XmlBillItem>();
        }
        return this.object;
    }
