 ...
 */
@WebService(name = "BillItemService", targetNamespace = "http://enum.element.webservice.remote.oryx.com")
...
@XmlSeeAlso({
        ...
        com.oryx.remote.webservices.service.billitemservice.ObjectFactory.class,
...
public interface BillItemService {
    ...
    /**
     * @param crudRequest
     * @return returns com.oryx.remote.webservices.service.billitemservice.CrudResponse
     */
    @WebMethod
    @WebResult(name = "crudResponse", targetNamespace = "http://com/oryx/remote/webservices/service/billitemservice", partName = "crudResponse")
    public CrudResponse crud(
            @WebParam(name = "crudRequest", targetNamespace = "http://com/oryx/remote/webservices/service/billitemservice", partName = "crudRequest")
