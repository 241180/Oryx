 ...
 */
@WebService(name = "PatientService", targetNamespace = "http://enum.element.webservice.remote.oryx.com")
...
@XmlSeeAlso({
        ...
        com.oryx.remote.webservices.service.patientservice.ObjectFactory.class,
...
public interface PatientService {
    ...
    /**
     * @param crudRequest
     * @return returns com.oryx.remote.webservices.service.patientservice.CrudResponse
     */
    @WebMethod
    @WebResult(name = "crudResponse", targetNamespace = "http://com/oryx/remote/webservices/service/patientservice", partName = "crudResponse")
    public CrudResponse crud(
            @WebParam(name = "crudRequest", targetNamespace = "http://com/oryx/remote/webservices/service/patientservice", partName = "crudRequest")
