 ...
 *         &lt;element name="Object" type="{http://sale.bu.model.element.webservice.remote.oryx.com}XmlCartItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlCartItem> object;
     ...
     * {@link XmlCartItem }
     */
    public List<XmlCartItem> getObject() {
        if (object == null) {
            object = new ArrayList<XmlCartItem>();
        }
        return this.object;
    }
