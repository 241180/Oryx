 ...
 *         &lt;element name="Object" type="{http://ose.system.model.element.webservice.remote.oryx.com}XmlRoleInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudResponse {
    ...
    protected List<XmlRoleInfo> object;
     ...
     * {@link XmlRoleInfo }
     */
    public List<XmlRoleInfo> getObject() {
        if (object == null) {
            object = new ArrayList<XmlRoleInfo>();
        }
        return this.object;
    }
