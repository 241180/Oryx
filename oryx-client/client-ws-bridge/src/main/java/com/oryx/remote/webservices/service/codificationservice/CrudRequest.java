package com.oryx.remote.webservices.service.codificationservice;
 ...
 *         &lt;element name="Object" type="{http://ose.system.model.element.webservice.remote.oryx.com}XmlCodification" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlCodification> object;
     ...
     * {@link XmlCodification }
     */
    public List<XmlCodification> getObject() {
        if (object == null) {
            object = new ArrayList<XmlCodification>();
        }
        return this.object;
    }
