 ...
 */
@WebService(name = "MenuService", targetNamespace = "http://enum.element.webservice.remote.oryx.com")
...
@XmlSeeAlso({
        ...
        com.oryx.remote.webservices.service.menuservice.ObjectFactory.class,
...
public interface MenuService {
    ...
    /**
     * @param crudRequest
     * @return returns com.oryx.remote.webservices.service.menuservice.CrudResponse
     */
    @WebMethod
    @WebResult(name = "crudResponse", targetNamespace = "http://com/oryx/remote/webservices/service/menuservice", partName = "crudResponse")
    public CrudResponse crud(
            @WebParam(name = "crudRequest", targetNamespace = "http://com/oryx/remote/webservices/service/menuservice", partName = "crudRequest")
