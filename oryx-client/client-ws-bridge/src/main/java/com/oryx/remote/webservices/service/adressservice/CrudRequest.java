 ...
 *         &lt;element name="Object" type="{http://ref.system.model.element.webservice.remote.oryx.com}XmlAdress" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlAdress> object;
     ...
     * {@link XmlAdress }
     */
    public List<XmlAdress> getObject() {
        if (object == null) {
            object = new ArrayList<XmlAdress>();
        }
        return this.object;
    }
