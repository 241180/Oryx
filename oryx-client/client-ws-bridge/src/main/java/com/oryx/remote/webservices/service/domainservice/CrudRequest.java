 ...
 *         &lt;element name="Object" type="{http://ose.system.model.element.webservice.remote.oryx.com}XmlDomain" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlDomain> object;
     ...
     * {@link XmlDomain }
     */
    public List<XmlDomain> getObject() {
        if (object == null) {
            object = new ArrayList<XmlDomain>();
        }
        return this.object;
    }
