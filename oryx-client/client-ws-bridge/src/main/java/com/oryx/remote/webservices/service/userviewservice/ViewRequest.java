package com.oryx.remote.webservices.service.userviewservice;
 ...
 *         &lt;element name="Object" type="{http://ose.system.view.element.webservice.remote.oryx.com}XmlUserView" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ViewRequest {
    ...
    protected List<XmlUserView> object;
     ...
     * {@link XmlUserView }
     */
    public List<XmlUserView> getObject() {
        if (object == null) {
            object = new ArrayList<XmlUserView>();
        }
        return this.object;
    }
