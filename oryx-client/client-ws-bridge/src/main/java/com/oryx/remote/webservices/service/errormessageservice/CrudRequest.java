package com.oryx.remote.webservices.service.errormessageservice;
 ...
 *         &lt;element name="Object" type="{http://msg.system.model.element.webservice.remote.oryx.com}XmlErrorMessage" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudRequest {
    ...
    protected List<XmlErrorMessage> object;
     ...
     * {@link XmlErrorMessage }
     */
    public List<XmlErrorMessage> getObject() {
        if (object == null) {
            object = new ArrayList<XmlErrorMessage>();
        }
        return this.object;
    }
