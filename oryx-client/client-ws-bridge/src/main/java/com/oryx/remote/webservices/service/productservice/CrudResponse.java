 ...
 *         &lt;element name="Object" type="{http://sale.bu.model.element.webservice.remote.oryx.com}XmlProduct" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudResponse {
    ...
    protected List<XmlProduct> object;
     ...
     * {@link XmlProduct }
     */
    public List<XmlProduct> getObject() {
        if (object == null) {
            object = new ArrayList<XmlProduct>();
        }
        return this.object;
    }
