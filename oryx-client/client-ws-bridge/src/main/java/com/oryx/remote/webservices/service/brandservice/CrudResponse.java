 ...
 *         &lt;element name="Object" type="{http://sale.bu.model.element.webservice.remote.oryx.com}XmlBrand" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrudResponse {
    ...
    protected List<XmlBrand> object;
     ...
     * {@link XmlBrand }
     */
    public List<XmlBrand> getObject() {
        if (object == null) {
            object = new ArrayList<XmlBrand>();
        }
        return this.object;
    }
