...
public final class UserTypeByTokenProvider extends TypeByTokenProvider {
    private static final Class<?> ENTITY_CLASS_TYPE = XmlUser.class;
    private static final Class<?> XML_ENTITY_CLASS_TYPE = XmlUser.class;
